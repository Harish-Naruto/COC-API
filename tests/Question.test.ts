...
describe("get question by Id", () => {
  it("should respond with 200 and get the question by Id", async () => {
    ...
    const spy = jest
      .spyOn(questionServices, "getQuestionByTopicId")
  ...
  it("should throw error 400 for missing field", async () => {
    ...
    await expect(getQuestionByTopicId(req, res)).rejects.toThrow(
      new ApiError("required field missing", 400),
    );
  });
});
...
describe("add question", () => {
  it("should respond with 200 and add question", async () => {
    ...
    const res = mockResponse();
    const spy = jest
      .spyOn(questionServices, "addQuestionByTopicId")
      .mockResolvedValue(baseMockQuestion);
...
describe("get Question by questionId", () => {
  it("should respond with 200 and get the question by questionId", async () => {
    ...
    const res = mockResponse();
    const spy = jest
      .spyOn(questionServices, "getQuestionByQuestionId")
      .mockResolvedValue(baseMockQuestion);
  ...
  it("should throw error 400 for missing field", async () => {
    ...
    await expect(getQuestionByQuestionId(req, res)).rejects.toThrow(
      new ApiError("required field missing", 400),
    );
  });
});
...
describe("update question", () => {
  it("should respond with 200 and update question", async () => {
    ...
    const spy = jest
      .spyOn(questionServices, "updateQuestion")
  ...
  it("should throw 400 for missing field", async () => {
    ...
    await expect(updateQuestion(req, res)).rejects.toThrow(
      new ApiError("required field missing", 400),
    );
  });
});
...
describe("delete question", () => {
  it("should respond with 200 and delete question", async () => {
    ...
    const spy = jest
      .spyOn(questionServices, "deleteQuestion")
      .mockResolvedValue(baseMockQuestion);
